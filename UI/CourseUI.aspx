<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseUI.aspx.cs" Inherits="ExamHallManagentSystemApp.UI.CourseUI" %>
...
<head runat="server">
    ...
    <style>
         body {
            background-image: url("../Images/Flying-Student-Background.jpg");
            background-size: 1310px 610px;
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <div class="col-2">
                     <asp:Label ID="Label1" runat="server" Text="Couse Id" class="control-label"></asp:Label>
                </div>
                <div class="col-8">
                        <asp:TextBox ID="courseIdTextBox" runat="server" class="form-control"></asp:TextBox>
                  </div>
            </div>
           <div class="row">
                <div class="col-2">
                     <asp:Label ID="Label2" runat="server" Text="Course Name" class="control-label"></asp:Label>
                </div>
                <div class="col-8">
                       <asp:TextBox ID="courseNameTextBox" runat="server" class="form-control"></asp:TextBox>
                  </div>
            </div>
             <div class="row">
                <div class="col-2">
                      <asp:Label ID="Label3" runat="server" Text="Credit" class="control-label"></asp:Label>
                </div>
                <div class="col-8">
                       <asp:TextBox ID="creditTextBox" runat="server" class="form-control"></asp:TextBox>
                  </div>
            </div>

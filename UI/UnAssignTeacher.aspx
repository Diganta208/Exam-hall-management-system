<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnAssignTeacher.aspx.cs" Inherits="ExamHallManagentSystemApp.UI.UnAssignTeacher" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4">
                     <asp:Button ID="unassignButton" runat="server" Text="Unassign Teacher" OnClick="unassignButton_Click" class="btn btn-warning btn-lg" />
                </div>
            </div>
